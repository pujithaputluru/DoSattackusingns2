...
$ns duplex-link $client1 $server1 15Mb 100ms DropTail
$ns duplex-link $client2 $server1 15Mb 100ms DropTail
$ns duplex-link $attacker $server1 15Mb 100ms DropTail
$ns duplex-link $server1 $server2 10Mb 200ms DropTail
...
$cbr2 set packet_size_ 6000
$cbr2 set rate_ 0.6mb
$cbr2 set random_ false
$cbr2 set interval_ 0.06
